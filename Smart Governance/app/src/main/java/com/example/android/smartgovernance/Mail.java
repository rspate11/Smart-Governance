...
public class Mail extends javax.mail.Authenticator {
    ...
    private String _dmail="78vrundapatel@gmail.com";
        ...
        if(!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") &&
            ...
            Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("78vrundapatel@gmail.com","vrundapatel78");
                }
            });
...
// send email
            ...
            try {
                t.connect("smtp.gmail.com","78vrundapatel@gmail.com","vrundapatel78");
    ...
    private Properties _setProperties() {
        ...
        props.put("mail.smtp.user",_dmail);
